...
public class UsersFactory {
    ...
    public static Admin createAdmin(String id, String fullName, double salary, String password) {
        return new Admin(id, fullName, salary, password);
    }

    public static GraduateStudent createGraduateStudent(String id, String fullName, Faculty faculty, Date enrollmentDate, Degree degree, int yearOfStudy, String password) {
        return new GraduateStudent(id, fullName, faculty, enrollmentDate, degree, yearOfStudy, password);
    }
}